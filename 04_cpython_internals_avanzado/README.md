...
1. [Historia del GIL](01_historia_del_gil/)
2. [Limitaciones del GIL tradicional](02_limitaciones_del_gil/)

### Sección 2: Free-Threading (PEP 703)
3. [PEP 703: Free-Threading Python 3.13+](03_pep_703_free_threading/)
4. [Activación de free-threading](04_activacion_free_threading/)
5. [Arquitectura interna sin GIL](05_arquitectura_sin_gil/)
...
9. [Compatibilidad de extensiones C](09_compatibilidad_extensiones_c/)
...
14. [Aislamiento de memoria](14_aislamiento_memoria/)
15. [Canales de comunicación](15_canales_comunicacion/)

### Sección 4: Thread-Safety
16. [Operaciones atómicas](16_operaciones_atomicas/)
17. [Data races y race conditions](17_data_races/)
18. [Locks y sincronización](18_locks_sincronizacion/)
19. [Threading.local y TLS](19_threading_local/)
20. [Estructuras thread-safe](20_estructuras_thread_safe/)

### Sección 5: Internals de Objetos
21. [PyObject: estructura interna](21_pyobject_estructura/)
...
26. [Estrategias de migración](26_estrategias_migracion/)
