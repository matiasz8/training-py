...
2. Ver talk de David Beazley sobre GIL (1 hora)
3. Estudiar código fuente de CPython: `Python/ceval_gil.c`
4. Experimentar con nogil fork

### Ejercicios Recomendados
1. Replicar experimentos de David Beazley con GIL visualization
2. Comparar rendimiento: CPython vs PyPy vs nogil
3. Implementar GIL-like mutex para entender el diseño
