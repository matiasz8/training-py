...
1. [uv: Introducción y arquitectura](01_uv_introduccion_arquitectura/)
2. [uv: Instalación y configuración inicial](02_uv_instalacion_configuracion/)
3. [uv pip: Instalación de paquetes ultrarrápida](03_uv_pip_instalacion_paquetes/)
4. [uv venv: Gestión de entornos virtuales](04_uv_venv_entornos_virtuales/)
5. [uv tool: Herramientas globales](05_uv_tool_herramientas_globales/)
...
10. [Ruff: Introducción y velocidad](10_ruff_introduccion_velocidad/)
11. [Ruff como linter: reglas disponibles](11_ruff_linter_reglas/)
...
14. [Configuración en pyproject.toml](14_ruff_configuracion_pyproject/)
15. [Reglas estrictas para código de producción](15_ruff_reglas_estrictas/)
16. [Performance benchmarks](16_ruff_performance_benchmarks/)
17. [Integración en workflow (pre-commit, CI/CD)](17_ruff_integracion_workflow/)

### Grupo 3: Type Checkers Modernos (6 temas)
18. [mypy: Estado actual en 2026](18_mypy_estado_actual_2026/)
