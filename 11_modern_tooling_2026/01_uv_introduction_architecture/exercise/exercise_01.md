...
1. Si no está instalado, instálalo:

   ```bash
   curl -LsSf https://astral.sh/uv/install.sh | sh
   ```

1. Verifica la ubicación de la caché:

   ```bash
   uv cache dir
   ```

1. Explora el contenido de la caché (si existe):
...
1. Compara los tiempos. ¿Cuánto más rápido es uv?
...
1. Observa la salida de la segunda instalación. ¿Fue instantánea?

1. Revisa el tamaño de la caché:
...
01. Experimenta con conflictos de dependencias:
...
01. Compara el mensaje de error de uv vs pip. ¿Cuál es más claro?

## Preguntas de Reflexión

1. ¿Por qué uv es más rápido que pip?
1. ¿Qué ventajas ofrece la caché global?
1. ¿En qué escenarios sería más beneficioso usar uv?
1. ¿Qué desventajas o riesgos podrías identificar?
